...
LOG_FORMAT = ('%(asctime) -5s %(levelname)s'
              ': %(message)s')
...
class HashingConsumer(object):
    ...
    def __init__(self, amqp_url, ):
        ...
        URL used to connect to RabbitMQ adnd redis connection
    ...
    def on_message(self, _unused_channel, basic_deliver, properties, body):
        ...
        try:
            ...
            LOGGER.info(f'Received request to hash {file_name} as {hash_type}')
            hash_file(file_name, hash_type)
...
class ReconnectingHashingConsumer(object):
    ...
    def __init__(self, amqp_url):
        ...
        self._consumer = HashingConsumer(self._amqp_url)
...
def main():
    ...
    consumer = ReconnectingHashingConsumer(AMPQ_URL)
    consumer.run()
